...
export function GleedWaySection() {
  return (
    <section id="gleed-way" className="py-20 sm:py-24 bg-muted/40">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:items-start">
              <Card className="py-0 h-fit lg:self-center">
                <CardContent className="p-8 sm:p-10">
                  ...
                  <h3 className="mb-4 text-xl font-medium tracking-tight text-muted-foreground ">
                    Website Builders
                  </h3>
                  <ul className="space-y-4">
                    {websiteBuilderPainPoints.map((item) => (
                      <li key={item} className="flex items-start gap-2 text-muted-foreground text-sm mb-3">
                        <X className="mt-0.5 h-4 w-4 shrink-0 text-black/50 " />
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
              ...
              <Card className="py-0 shadow-xl ring-1 ring-1 ring-primary">
                <CardContent className="p-8 sm:p-10 relative">
                  <Badge variant="outline" className="mb-4 absolute top-5 right-5 ">
                    Top Choice
                  </Badge>
                  <div className="mb-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-muted">
                      <ThemedSvgIcon
                        src="/icons/gleed-way-fire.svg"
