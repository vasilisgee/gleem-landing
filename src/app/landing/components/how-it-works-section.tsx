...
const values = [
  ...
  },
  {
    ...
    peepSrc: "/peeps/gleed-peep-step-3.webp",
...
export function HowItWorksSection() {
  return (
    <section id="how-it-works" className="scroll-mt-15 pt-10 pb-20">
              ...
              <Card key={index} className="group py-2 shadow-xs">
                <CardContent className="p-8">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <div className="relative mb-6 flex h-36 w-36 items-end justify-center overflow-hidden rounded-full bg-muted/40 px-3 pt-3 pb-0">
                      <ThemedSvgIcon
                        src={value.iconSrc}
